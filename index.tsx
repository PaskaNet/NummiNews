...
const App = () => {
    ...
    const alkanEGahmarArticle: NewsArticle = {
        category: 'Konflikti',
        title: 'NUMMINEWS – MAROVIAN SISÄLLISSOTA JULISTETTU PÄÄTTYNEEKSI, MUTTA ALAKAN E. GAHMAR YHÄ VAPAANA — UUSIA SUUNNITELMIA RAPORTOITU',
        snippet: 'Marovian sisällissota on julistettu päättyneeksi, mutta kapinallisjohtaja Alkan E. Gahmar on yhä vapaana ja suunnittelee uusia iskuja.',
        imageUrl: 'https://i.postimg.cc/FRtRK7fT/Nayttokuva-2025-11-05-102924.png',
        author: "NummiNews-toimitus / KNV–KNT kenttäraportit, Marovia",
        publishedDate: "1.11.2025",
        fullContent: [
            "Marovian hallitus on virallisesti ilmoittanut sisällissodan päättyneeksi, mutta konfliktin synkimmistä hahmoista tunnettu Alkan E. Gahmar on edelleen vapaana. Kenttälähteiden ja tiedusteluraporttien mukaan hän on nähty useaan otteeseen Badlandsin ja Etelä-Khalimanin rajavyöhykkeellä, missä hänen uskollisimmat joukkonsa — niin kutsutut “bunnerit” — jatkavat organisoitumista.",
            "Kuka on Alkan E. Gahmar?",
            "Alkan E. Gahmar on South Khaliman City Rebel Aggression Groupin (SKCRAG) perustaja ja johtaja, sekä Khalimanin kapinaliikkeen keskeinen komentaja.",
            "Hän on entinen Marovian armeijan upseeri, joka karkotettiin asevoimista kolme vuotta sitten korruptioepäilyjen ja siviiliväkivaltaan liittyvien tapausten vuoksi. Pian karkotuksensa jälkeen Gahmar perusti oman militanttiryhmänsä, jota hän koulutti salaisissa tukikohdissaan Khalimanin ja Badlandsin alueilla.",
            "Häntä vastaan on nostettu lukuisia syytteitä sekä Maroviassa että Kirkkonummella:",
            "Sotarikokset",
            "Tahalliset siviilikohteiden pommitukset (14 vahvistettua tapausta Lemburassa)",
            "Kidutuskammiot ja pakkotyöleirit Badlandsin bunkkereissa",
            "Käsky ampua pohjoiseen pakenevia siviilejä",
            "Terroristinen toiminta",
            "SKCRAG:n aseistaminen ja infrastruktuurihyökkäykset",
            "Räjähteiden käyttö lentokenttäalueilla — kymmeniä kuolonuhreja",
            "Ihmiskauppa ja pakkotyö",
            "“Kadonneiden” marovialaisten käyttö bunkkerityövoimana (arvio jopa 20 000 henkilöä)",
            "Muut rikokset",
            "Sabotaasi Marovia–Kirkkonummi -logistiikkalinjaa vastaan",
            "Väitetty yhteys ulkopuoliseen asevientikanavaan Etelä-Nuristaniin",
            "Tilanne nyt",
            "Marovian hallitus on ilmoittanut sodan päättyneen ja Pohjois-Marovian sekä Lemburan alueiden olevan jälleen hallinnassa, mutta SKCRAG:n jäännösjoukot ovat edelleen aktiivisia.",
            "Useat lähteet raportoivat, että Gahmar on laatimassa uutta “operaatiokonseptia” bunnereilleen, joiden tarkoituksena olisi häiritä jälleenrakennusta ja luoda epävakautta alueelle.",
            "Kirkkonummen turvallisuusviranomaiset seuraavat tilannetta tiiviisti. KNT:n tiedustelulähteiden mukaan Gahmarin uskolliset yksiköt ovat edelleen aseistettuja ja kykeneviä iskuoperaatioihin.",
            "”Vaikka Marovian sota on virallisesti ohi, Gahmarin varjo roikkuu edelleen maan yllä,” totesi KNT:n turvallisuusanalyytikko aamun tiedotustilaisuudessa. “Jos hän onnistuu kokoamaan joukkonsa uudelleen, seurauksena voi olla uusi väkivallan aalto.”",
            "SKCRAG:n jäljellä oleva uhka",
            "Vaikka ryhmä on pirstaloitunut ja menettänyt useimmat tukikohtansa, osa sen infrastruktuurista on yhä toiminnassa Badlandsin eteläosissa. Satelliittikuvissa on havaittu uudelleenrakennettuja bunkkerirakenteita sekä liikettä vanhoilla varastoalueilla.",
            "Marovian ja Kirkkonummen viranomaiset pitävät Gahmaria korkean prioriteetin etsintäkohteena, ja hänen kiinniottamisensa on määritelty strategiseksi turvallisuustavoitteeksi.",
            "🕯️ Marovian rauha on hauras.",
            "Vaikka aseellinen konflikti on laantunut, Gahmarin vapaus muistuttaa siitä, että sota voi syttyä uudelleen — milloin tahansa. Kirkkonummen ja Nova-liiton viranomaiset kehottavat pysymään valppaana ja seuraamaan virallisia tiedotteita alueen turvallisuustilanteesta."
        ],
        images: [],
    };

    const ironDomeArticle: NewsArticle = {
        category: 'Paikallinen',
        title: 'NUMMINEWS – “TÄHDENLENTOJA” PAJUMÄESSÄ: KNV TESTASI IRON DOME -JÄRJESTELMÄÄ – VALMISTUMINEN LÄHELLÄ',
        snippet: 'KNV:n Iron Dome -ohjusjärjestelmän testit valaisivat Pajumäen yötaivasta, herättäen asukkaiden uteliaisuuden. Järjestelmä on lähes käyttövalmis.',
        imageUrl: 'https://i.postimg.cc/ZKcRH715/Nayttokuva-2025-11-05-095721.png',
        author: "NummiNews-toimitus",
        publishedDate: "1.11.2025",
        fullContent: [
            "Useat Pajumäen ja Keskustan asukkaat havaitsivat viime yönä poikkeuksellisia valoilmiöitä taivaalla, joita moni luuli ensin tähdenlennoiksi. Myöhemmin KNV (Kirkkonummen Infrastruktuuriyhtiö) vahvisti, että kyseessä oli Iron Dome -ohjusjärjestelmän testivaiheen laukaisuharjoitus.",
            "KNV:n tiedotteen mukaan yhtiö suoritti yön aikana “ohjuksentorjuntajärjestelmän täyden spektrin testejä” osana Kirkkonummen laajempaa ilmapuolustuksen kehitysohjelmaa. Testit sisälsivät sekä laukaisu- että torjuntaharjoituksia simuloiduilla kohteilla.",
            "”Harjoitus sujui erinomaisesti. Kaikki ohjukset toimivat suunnitellusti, ja järjestelmä saavutti täydellisen torjuntatarkkuuden testiskenaarioissa,” kertoi KNV:n edustaja aamuvarhaisella.",
            "Pajumäen taivaalla nähtiin useita nopeita valojuovia ja kuultiin useita matalia jyrähdyksiä, jotka herättivät alueen asukkaita. Pelastuslaitokselle tuli kymmeniä soittoja, mutta mitään vaaraa ei aiheutunut.",
            "Iron Dome -järjestelmä on osa KNV:n ja Kirkkonummen puolustusrakenteiden laajaa uudistusohjelmaa, jolla pyritään takaamaan alueen siviiliturvallisuus mahdollisten ohjusuhkien varalta. Testien kerrotaan olevan viimeisiä ennen järjestelmän täyttä käyttöönottoa.",
            "”Tämä on historiallinen askel Kirkkonummen ilmapuolustukselle. Iron Dome -järjestelmä on lähes valmis,” KNV:n puolustustekninen johtaja totesi.",
            "Virallisen arvion mukaan järjestelmä tullaan liittämään Kirkkonummen turvaverkkoon vuoden loppuun mennessä."
        ],
        images: [],
    };
    ...
    const kntRevenueArticle: NewsArticle = {
        ...
        fullContent: [
            ...
            "KNT:n yleiskomentaja lisäsi: ”Kasvu antaa meille mahdollisuuden vahvistaa valmiutta, kehittää teknologiaa ja investoida henkilöstön koulutukseen – kaikki tämä tukee Kirkkonummen turvallisuutta pitkällä aikaväillä.”",
    ...
    const nuclearPlantArticle: NewsArticle = {
        ...
        fullContent: [
            ...
            "“Tavoitteemme on luoda tehokas ja turvallinen voimalaitos, joka hyödyntää uusinta sukupolvea edustavaa pienydinreaktoriteknologiaa. Tämä hanke on välttämätön, jotta voimme turvata energian hinnan ja huoltovarmuuden pitkällä aikaväillä,” kertoi KNV:n toimitusjohtaja aamun tiedotteessa.",
    ...
    const nuristanReconstructionArticle: NewsArticle = {
        ...
        fullContent: [
            ...
            "Lähellä sijaitseva kristittyjen klaani on jo ilmaissut valmiutensa tukea Nuristania tarpeen mukaan, mikä antaa alueelle lisäresurssi ja suojaa mahdollisia väkivaltaisia pyrkimyksiä vastaan.",
    ...
    const welcomeArticle: NewsArticle = {
        ...
        imageUrl: 'data:image/jpeg;base64,-',
        author: "NummiNews Toimitus",
        ...
        images: [
            'data:image/jpeg;base64,-',
